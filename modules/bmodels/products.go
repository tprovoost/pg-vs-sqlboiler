...
var ProductWhere = struct {
	...
	Title:     whereHelpernull_String{field: "\"products\".\"title\""},
...
var (
	productAllColumns            = []string{"id", "title", "price", "created_at", "deleted_at", "tags"}
	productColumnsWithoutDefault = []string{"title", "price", "created_at", "deleted_at", "tags"}
...
func (o *Product) PurchaseItems(mods ...qm.QueryMod) purchaseItemQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"purchase_items\".\"product_id\"=?", o.ID),
	)
...
func (productL) LoadPurchaseItems(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProduct interface{}, mods queries.Applicator) error {
	var slice []*Product
	var object *Product
	...
	query := NewQuery(
		...
		qm.WhereIn(`purchase_items.product_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Product) AddPurchaseItems(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*PurchaseItem) error {
	var err error
...
// Sets o.R.Product's PurchaseItems accordingly.
// Replaces o.R.PurchaseItems with related.
// Sets related.R.Product's PurchaseItems accordingly.
func (o *Product) SetPurchaseItems(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*PurchaseItem) error {
	query := "update \"purchase_items\" set \"product_id\" = null where \"product_id\" = $1"
...
func (o *Product) RemovePurchaseItems(ctx context.Context, exec boil.ContextExecutor, related ...*PurchaseItem) error {
	var err error
	for _, rel := range related {
		queries.SetScanner(&rel.ProductID, nil)
		if rel.R != nil {
